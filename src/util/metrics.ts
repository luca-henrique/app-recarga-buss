...
export const $METRICS = {
  ...
  // Fonts
  titleFontSizeBig: scale(14),

  // Paddings
  topBarContainerPadding: scale(30),

  // Icon and Images Size
  iconSmallWidth: scale(16),
  iconSmallHeight: scale(16),

  imageSmallWidth: scale(64),
  imageSmallHeight: scale(64),

  // elements size
  pillsWidth: scale(130),
  pillsHeight: scale(42),

  // Border sizes
  pillsRadius: scale(28),
